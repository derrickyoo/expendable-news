<?php	
	...
	if (!preg_match('^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$^', $_POST['email'])) {
		die("Invalid E-mail address. Back to: <a href='open.php?id=" . $_POST['post_id'] . "'>" . $_POST['post_title'] . "</a>");
	}
	
	if (empty($_POST['email']) || empty($_POST['comment'])) {
		die("Fill in all sections of the form to comment. Back to: <a href='open.php?id=" . $_POST['post_id'] . "'>" . $_POST['post_title'] . "</a>");
	}
